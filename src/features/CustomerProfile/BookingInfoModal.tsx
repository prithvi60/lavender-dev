                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div className='w-full pt-8'>
                                            ...
                                            <div>Cancel for free anytime in advance, otherwise you will be charged 
                                            100% of the service price for not showing up.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </Grid>
                        <Grid xs={4} sx={{backgroundColor: '#EEEEFF'}}>
