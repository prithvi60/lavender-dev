...
function Notifications({ userInfo }) {
  ...
  return (
    <div className='mt-10'>
      <Text sx={styles.heading} name={'Notification Preferences'} align="left"></Text>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className='p-5 lg:p-8 flex flex-col lg:flex-row'>
            <div className='w-full lg:w-5/12 flex flex-col gap-4'>
              <Text sx={styles.subHeading} name={"Appointment reminders"} align="left"/>
              
              <Text sx={styles.subHeading2} name={"We will notify about your appointments on time"} align="left"/>
            ...
            <div className='w-full lg:w-5/12 flex flex-col gap-4'>
              <Text sx={styles.subHeading} name={"Lavender promotions"} align="left"/>
              
              <Text sx={styles.subHeading2} name={"We send you marketing offers and news that you might find interesting"} align="left"/>
              <FormGroup>
                <Controller
                  name='promotionsMail'
                  control={control}
