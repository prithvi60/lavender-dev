  ...
  return (
    <>
      <div className="mt-2 md:mx-16 my-10 h-full urbanist-font">
        ...
        <div className="ml-6 mt-4">
          {!isUser && (
            <div>
              ...
              <p className="text-sm mb-4">
                We recommend you to register in Lavender. By registering, you
                gain access to exclusive features tailored just for you.{" "}
                <LoginModal />
              </p>
          ...
          <p className="mb-2 mt-6 text-sm">
            Wanna Leave Appointment notes? (optional){" "}
          </p>
          <TextField
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                className={`checkBoxCommon ${
                  termsError ? "errorCheckbox" : ""
                }`} // Conditionally apply error style
        ...
        <div className="ml-6">
          ...
          <p className="mb-2">
            1. To cancel an appointment, we require a minimum of 24 hours'
            notice prior to the scheduled appointment time.
          </p>
          <p className="mb-2">
            2. Failure to provide the required notice may result in a
            cancellation fee equivalent to 50% of the service cost.
          </p>
          <p className="mb-2">
            3. Same-day cancellations or no-shows will be subject to a
            cancellation fee equal to the full cost of the scheduled service.
          </p>
        </div>
      </div>
      ...
      <div className="ml-6 mt-4">
        <p className="font-semibold mb-4">Fill your details</p>
        <p className="text-sm mb-4">
          We recommend you to register in Lavender. By registering, you gain
          access to exclusive features tailored just for you. <LoginModal />
        </p>
      ...
      <div className="ml-6">
        <p className="font-bold my-4">Cancellation policy</p>
        <p className="mb-2">
          1. To cancel an appointment, we require a minimum of 24 hours' notice
          prior to the scheduled appointment time.
        </p>
        <p className="mb-2">
          2. Failure to provide the required notice may result in a cancellation
          fee equivalent to 50% of the service cost.
        </p>
        <p className="mb-2">
          3. Same-day cancellations or no-shows will be subject to a
          cancellation fee equal to the full cost of the scheduled service.
