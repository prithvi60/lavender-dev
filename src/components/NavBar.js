  ...
  return (
    <AppBar position="fixed" className="nav-bar">
      ...
      <GetIcon className='cursor-pointer' onClick= {gotoLandingPage} iconName='LavenderLogo'/>
        <Text onClick= {gotoLandingPage} align="left" className="cursor-pointer nav-bar-title flex" variant="h6" sx={{ flexGrow: 1 }} name="Lavender"/>
        {isSearchPage && <NavFilter />}
        <Stack spacing={2} direction="row">
        {/* <TextRouter className='nav-bar-title' variant="body2" name="Business" to={getAdminRoute()}/> */}
        <Button href={getAdminRoute()} variant="outlined">Business</Button>
