...
const SelectedService = ({service, deleteService}) => {
    return (
        <div className='flex justify-between p-4 rounded-lg shadow-lg mb-4'>
            <div className='flex flex-col mr-3 w-3/5'>
                <div>{service.options[0].optionName}</div>
                <div className='flex justify-evenly items-center'>
                    <span>{service.options[0].duration} mins</span>
                    |
    ...
    <div className='w-72'>
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <div className='rounded-lg mb-5 flex justify-between w-full p-3 border border-input bg-background hover:bg-accent hover:text-accent-foreground'>
                ...
                <div>
                    ...
                    {category.services.map((service) => (
                        <div>
                            ...
                            <DropdownMenuItem onClick={() => selectService(category, service, option )} className='font-normal'>
                                <div className='flex ml-6'><span><DotIcon/></span>{option.optionName}</div>
                            </DropdownMenuItem>
                        ))}
                        </div>
                    ))}
