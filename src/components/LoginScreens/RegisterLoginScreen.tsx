          ...
          >
            ...
            <Grid item xs={12} sx={{ padding: "10px" }}>
              <p style={{ color: "#545454" }}>
                {<Link onClick={() => handleRegisterClick()} className="cursor-pointer tracking-wider text-lg ">Register</Link>}To
                Create an account or login to book your next salon experience
                with Lavender.
              </p>
            </Grid>
